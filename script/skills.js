...
const skills=[
    { id: "skill-1", name: "JavaScript", percentage:100, color:"rgb(250, 206, 45),rgb(227, 172, 43)"},
    { id: "skill-2", name: "Java", percentage:90,color:"rgb(69, 137, 255),rgb(48, 102, 240)"},
    { id: "skill-3", name: "Springboot", percentage:80 ,color:"rgb(112, 179, 255),rgb(68, 127, 252)"},
    ...
    { id: "skill-11", name: "React", percentage:50 ,color:"rgb(69, 153, 255),rgb(45, 197, 227)"},
    { id: "skill-12", name: "Python", percentage:50 ,color:"rgb(255, 126, 28),rgb(245, 185, 47)"}
]
